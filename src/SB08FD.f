...
C             The desired stability degree to be assigned for
C             the eigenvalues of A+B*F. The eigenvalues outside the 
...
C
     ...
     $                              DWORK, P )
                        CALL DLACPY( 'Full', P, NB, DWORK, P, C(1,L),
     $                               LDC )
C
