...
C                             i+1|i
C             instant i. Otherwise, the leading N-by-N part of this
C             array contains P     , its input value.
C                             i|i-1
C
C     LDP     INTEGER
...
C                i    i i|i-1 i    i
C
C     P      is updated by the discrete algebraic Riccati equation
C      i|i-1
C
