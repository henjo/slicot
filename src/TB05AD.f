...
C             If BALEIG = 'B' or 'E' or BALEIG = 'A', then, on exit, the
C             leading N-by-N part of this array contains an upper
C             Hessenberg matrix similar to (via an orthogonal matrix
C             consisting of a sequence of Householder transformations)
C             the original state transition matrix A.
C
C     LDA     INTEGER
...
C             If BALEIG = 'B' or 'E' or BALEIG = 'A', then, on exit, the
C             leading N-by-M part of this array contains the product of
C             the transpose of the orthogonal transformation matrix used
C             to reduce A to upper Hessenberg form and the original
...
C             If BALEIG = 'B' or 'E' or BALEIG = 'A', then, on exit, the
C             leading P-by-N part of this array contains the product of
C             the original output/state matrix C and the orthogonal
C             transformation matrix used to reduce A to upper Hessenberg
C             form.
C
C     LDC     INTEGER
...
C             matrix H with respect to inversion.
C
...
C     REVISIONS
C
C     February 22, 1998 (changed the name of TB01RD).
C     February 12, 1999.
C
C     KEYWORDS
C
...
C     .. External Subroutines ..
     ...
     $                  MB02RZ, MB02SZ, MB02TZ, XERBLA
C     .. Intrinsic Functions ..
      INTRINSIC         DBLE, DCMPLX, INT
